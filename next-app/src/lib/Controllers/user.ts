...
export function ValidadeUserAcess(): Promise<ApiResponse> {
  return new Promise<ApiResponse>((resolve) => {
    ...
    axios
      .post<ApiResponse>(
        "https://gerenciador-empresarial-1cfr.vercel.app/home-acess",
...
export function AddNewCompany(
  ...
  return new Promise<ApiResponse>((resolve) => {
    axios
      .post<ApiResponse>("https://gerenciador-empresarial-1cfr.vercel.app/add-new-company", {
        email,
        id,
        password,
        companyName,
...
export function UserLoginAcess(
    ...
    return new Promise<ApiResponse>((resolve) => {
      ...
      axios.post<ApiResponse>('https://gerenciador-empresarial-1cfr.vercel.app/user-login', {
        email,
