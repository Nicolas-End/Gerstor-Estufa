...
import { AddNewTruck, ValidateHomeAcess, GetEspecificTruck } from "@/lib/ts/api";
            ...
            <div className="flex min-h-screen bg-gray-100 text-black">
                ...
                <div className="flex-1 p-8">
                    <div className="flex justify-between items-center mb-6 p-4 bg-white rounded-lg shadow">
                        <h1 className="text-2xl font-bold text-black">Editar Caminhão</h1>
                        <button
                            onClick={() => router.back()}
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-green-900 text-white py-3 px-4 rounded-lg font-semibold text-lg hover:bg-green-800 transition disabled:opacity-50"
                        >
                            {isLoading ? "Editando..." : "Editar Caminhão"}
                        </button>
                    </form>
                </div>
                <ToastContainer />
