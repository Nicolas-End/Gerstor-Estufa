      ...
      <div className="flex w-4/5 h-4/5 bg-white shadow-2xl rounded-lg overflow-hidden">
        ...
        <div className="w-1/2 bg-purple-700 text-white p-10 flex flex-col justify-center">
          ...
          <label className="flex items-center mb-4 text-sm">
            <input type="checkbox" className="mr-2" onChange={(e) => { setRememberUser (e.target.checked) }} />
            Remember me
          </label>
        ...
        <div className="w-1/2 flex items-center justify-center bg-pink-300 ">
          <div className="relative">
            <img
              src="Logo.png"
              alt="Logo"
              className="logo-image animate-bounce-smooth" // Aplicando a classe da imagem
            />
            <div className="logo-shadow" /> {/* Sombra abaixo da imagem */}
          </div>
        </div>
      </div>
    </div>
